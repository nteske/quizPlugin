...
gulp.task('assets', function () {
	return gulp.src(['control/assets/**/**']).pipe(gulp.dest(destinationFolder + '/control/assets'));
});
...
var buildTasksToRun=['controlHTML','widgetHTML','resources', 'assets', 'images','sharedJS'];
